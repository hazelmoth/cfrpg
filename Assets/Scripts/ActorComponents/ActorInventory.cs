...
namespace ActorComponents
{
    ...
    public class ActorInventory : IContainer, IActorComponent
    {
        ...
        public ActorInventory(InventoryData data)
        {
            Initialize();
            SetInventory(data);
        }
        ...
        public InventoryData GetContents()
        {
            InventoryData contents = new()
            {
        ...
        public void SetInventory([NotNull] InventoryData inv)
        {
        ...
        public void Clear()
        {
            SetInventory(new InventoryData());
        }
        ...
        private static InventoryData ReplaceBlankItemsWithNull(InventoryData inv)
        {
